...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-6 button-list" style="text-align: right">
            <a href="{{ url('user/assign_ministry') }}" class="btn my-2">Assign Members to Ministry</a>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ url('user/assign_ministry/list') }}" class="btn btn-danger">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        <tbody>
                            @foreach ($getRecord as $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('user/assign_ministry/edit', $value->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        <a href="{{ url('user/assign_ministry/delete', $value->id) }}" class="btn btn-danger btn-sm" onclick="confirmDelete(event, {{ $value->id }}, '{{ $value->member_name }}')">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        function confirmDelete(event, id, member_name) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                        window.location.href = `/user/assign_ministry/delete/${id}`;
                }
            });
        }
    </script>

...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-6 button-list" style="text-align: right">
            <a href="{{ url('user/church_resources/add') }}" class="btn my-2">Add Church Resources</a>
        </div>
                ...
                @foreach($getRecord as $resource)
                    <div class="col-lg-3 col-xl-2">
                        <div class="file-man-box">
                            ...
                            <a href="{{ url('user/church_resources/edit', $resource->id) }}" class="file-edit"><i class="fa fa-edit"></i></a> <!-- Edit Icon -->
    ...
    function confirmDelete(event, id, file_name) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `/user/church_resources/delete/${id}`;
            }
        });
    }
</script>
